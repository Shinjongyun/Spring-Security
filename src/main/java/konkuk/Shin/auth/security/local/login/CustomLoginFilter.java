...
import konkuk.Shin.auth.controller.dto.request.LocalLoginRequest;
...
public class CustomLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        LocalLoginRequest login;
        try {
            login = objectMapper.readValue(request.getInputStream(), LocalLoginRequest.class);
        } catch (IOException e) {
